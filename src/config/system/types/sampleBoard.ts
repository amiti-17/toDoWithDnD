  ...
  inProgress: [
    {
      title: "You can DnD",
      description:
        "You can DnD from other columns into this, to mark them as in progress...",
  ...
  done: [
    {
      ...
      description:
        "Here you can see task that you have already done. I will store here until you delete it, or one month is gone.",
